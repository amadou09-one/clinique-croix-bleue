...
/**
 * Mêmes règles que RegisterRequest, mais sans mot de passe : un mot de passe
 * aléatoire est généré côté serveur et jamais transmis en clair (voir
 * SecretairePatientController::store) — le patient le définit lui-même via
 * le lien reçu par e-mail.
 */
class StorePatientSecretaireRequest extends FormRequest
{
    /**
