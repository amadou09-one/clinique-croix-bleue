...
<p style="margin:0 0 20px;">Bonjour {{ $patient->prenom }},</p>
<p style="margin:0 0 24px;">
  Notre secrétariat vient de créer votre compte patient afin de faciliter la gestion de vos
  rendez-vous. Pour y accéder, définissez votre mot de passe en cliquant sur le bouton ci-dessous :
</p>
...
<p style="margin:0;color:#6B7280;font-size:13px;">
  Une fois votre mot de passe défini, vous pourrez consulter et gérer vos rendez-vous depuis votre espace patient.
</p>
@endsection
